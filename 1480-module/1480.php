...
$result = $scss->compile('@import"sass/1480.scss"');

file_put_contents("css/1480.css",$result);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="<?php echo $url_path ?>/css/1480.css">
    <script src="<?php echo $url_path ?>/js/jquery-3.2.0.min.js"></script>
    <script src="<?php echo $url_path ?>/js/bootstrap.min.js"></script>
    <title>Document</title>
</head>
<body>
    <?php include '1480-content.php' ?>
</body>
</html>