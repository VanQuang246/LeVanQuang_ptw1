...
$result = $scss->compile('@import"sass/1459.scss"');

file_put_contents("css/1459.css",$result);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="<?php echo $url_path ?>/css/1459.css">
